...
void downloadlog(State *current_state)
{
    ...
    while (index < (address / 10))
    {
        ...
        arr[0] = index + '0';
        arr[1] = ' ';
        arr[2] = read_eeprom((index * 10));
        arr[3] = read_eeprom((index * 10) + 1);
        arr[4] = ':';
        arr[5] = read_eeprom((index * 10) + 2);
        arr[6] = read_eeprom((index * 10) + 3);
        arr[7] = ':';
        arr[8] = read_eeprom((index * 10) + 4);
        arr[9] = read_eeprom((index * 10) + 5);
        arr[10] = ' ';
        arr[11] = read_eeprom((index * 10) + 6);
        arr[12] = read_eeprom((index * 10) + 7);
        arr[13] = ' ';
        arr[14] = read_eeprom((index * 10) + 8);
        arr[15] = read_eeprom((index * 10) + 9);
        arr[16] = '\n';
        arr[17] = '\r';
        arr[18] = '\0';
